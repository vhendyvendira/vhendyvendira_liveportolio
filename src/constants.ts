...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    context: "Over the past 5 years in Indonesia, illegal investments and scam schemes (Ponzi and pyramid) have caused **losses of IDR 50–140 trillion**, impacting more than 5 million victims across **2,400+ entities**. Despite financial inclusion reaching **85.10%**, financial literacy remains at **49.68**%, exposing a **critical gap between access and understanding** that is actively exploited.\n\nThe consequences extend beyond financial loss, with **42% of victims experiencing severe psychological distress**, and up to **1.2 million new victims emerging annually**. Notably, **68% of victims reported initial suspicion** but lacked an objective way to validate their concerns.",
    problem: "There is no objective and structured system to deconstruct business models and distinguish real value creation from participant-funded cash flow, resulting in unreliable risk assessment prior to financial decisions.",
    challenge: "The challenge is not about labeling entities as “legal” or “illegal”—because many do not fit cleanly into either category. If an entity is ==formally registered==, operates under regulatory oversight, ==sells tangible products==, delivers consistent early returns, and builds a strong reputation with modern technology—**should it be considered illegal?**\n\nIn reality, many entities meet all of these signals of legitimacy, yet still operate on fundamentally unsustainable structures. Protected by strong legal framing and well-crafted terms, they exist in a **gray zone where traditional definitions and enforcement struggle to apply.**",
    approach: "To address this, I designed **SRAF (Sustainable Risk Analysis Framework)**—a multi-dimensional framework designed to systematically analyze business models and assess their sustainability and risk.\n\nBuilt on 6 years of field observation and case analysis, SRAF powers an AI-driven system that deconstructs financial flows, operational structures, and growth mechanisms, producing an explainable risk assessment—**not as a legal verdict ('scam' or not)**, but as a clear and structured basis for decision-making.",
  ...
  },
  {
    ...
    context: "MetaGo was designed as a bridge between the traditional film industry and Web3 entertainment, aiming to solve trust issues through transparent tokenomics.",
