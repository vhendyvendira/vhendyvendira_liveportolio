...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    context: "Over the past five years in Indonesia, losses from illegal investments and scams (Ponzi and pyramid schemes) have reached an estimated IDR 50–140 trillion, affecting more than 5 million victims across 2,400+ entities.",
    problem: "There is no objective and structured system capable of deconstructing business models to distinguish between genuine value creation and participant-funded cash flow, to reliably assess risk before making financial decisions.",
    challenge: "The difficulty lies in the ambiguous nature of modern schemes.\n\nMany entities operate in legal gray areas—combining legitimate elements (registered entities, physical products, early returns) with unsustainable financial structures. This makes traditional detection methods ineffective, as they rely on binary classification (legal vs illegal) rather than structural analysis.",
    approach: "To address this, I initiated a solution designed to systematically analyze and assess the risk of unsustainable schemes such as Ponzi and pyramid structures (SURE Framework).",
