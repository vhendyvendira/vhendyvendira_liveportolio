...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    problem: "High demand driven by FOMO and holding incentives creates a foundation to convert passive accumulation into **active ecosystem engagement**.\n\nThe upcoming Film Tokenization Launchpad further drives anticipation, making it critical to transition users from speculators into active participants.",
    challenge: "Users acquire and operate virtual cinemas as production hubs for film templates. These templates represent different tiers of production with unique cost structures and earning potentials.\n\nTo sustain rewards, users must perform periodic 'marketing pushes'. This mechanism ensures that film assets remain operational while acting as **active engagement proof** within the ecosystem.",
    approach: "The GTM strategy focused on translating complex mechanics into **simple, direct value narratives**. This approach made the product easy to adopt through early community-driven channels.\n\nKey messaging focused on managing cinemas for recurring rewards and maintaining active film production, which successfully activated users within the internal WhatsApp community distribution.",
